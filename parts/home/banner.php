    ...
    <div class="container mx-auto relative z-40">
        <div class="flex flex-col w-full items-start justify-center h-[680px] text-white ">
            ...
            <p class="text-[18px] mt-5">
                Вам необходим партнер оказывающий технологическую поддержку который понимает насколько важно для Вашего бизнеса<br> поддерживать работоспособность Ваших систем на пиковой производительности.<br>
